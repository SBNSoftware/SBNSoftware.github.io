...
csrf-token: 4FomoMfj1c19GixCXFN20Lj/Vndhe/Fiyu6NzCex6PN11VHhPdMvf1akKvDTOcD2XWcEI/wFh0cvUJ4WYgRUJg==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: Shift Assignments - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/Shift_Assignments/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29137&object_type=wiki_page){.wiki_page-29137-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/Shift_Assignments/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/Shift_Assignments/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/Shift_Assignments){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/Shift_Assignments/history){.icon
.icon-history}
:::
...
# Shift assignments and swaps[¶](#Shift-assignments-and-swaps){.wiki-anchor}

See the [Shift Assignment
Algorithm](https://sbn-docdb.fnal.gov/cgi-bin/private/ShowDocument?docid=17443){.external}
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/Shift_Assignments/edit?section=2){.icon-only
.icon-edit}
:::
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/Shift_Assignments/edit?section=3){.icon-only
.icon-edit}
:::

[]{#Shift-assignment}

## **Shift assignment**[¶](#Shift-assignment){.wiki-anchor}
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/Shift_Assignments/edit?section=4){.icon-only
.icon-edit}
:::

[]{#Shift-swaps}

## **Shift swaps**[¶](#Shift-swaps){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/Shift_Assignments.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/Shift_Assignments.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/Shift_Assignments.txt){.txt}
