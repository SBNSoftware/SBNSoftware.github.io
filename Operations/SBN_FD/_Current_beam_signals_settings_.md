...
csrf-token: VByfm0s/KnN3NpgQbJ3XIJ4FCIS+G2HSVww86MNQQvvBk+jasQ/QwVyInqLj92EGe51a0CNlF/eysi8yhuX+Lg==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: Current beam signals settings - ICARUS operations - Fermilab
  Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29911&object_type=wiki_page){.wiki_page-29911-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_/history){.icon
.icon-history}
:::
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_/edit?section=2){.icon-only
.icon-edit}
:::

[]{#MI-60}

# MI-60[¶](#MI-60){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/_Current_beam_signals_settings_.txt){.txt}
