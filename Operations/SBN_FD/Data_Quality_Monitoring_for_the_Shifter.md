...
csrf-token: WQkeJkQrWH/ee5/nO/o0ZAYo63ERfH235Y4cE5VmeCvMhmlnvhuizfXFmVW0kIJC47C5JYwCC5IAMA/J0NPE/g==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: Data Quality Monitoring for the Shifter - ICARUS operations -
  Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=28318&object_type=wiki_page){.wiki_page-28318-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter/history){.icon
.icon-history}
:::
...
# Data Quality Monitoring for the Shifter[¶](#Data-Quality-Monitoring-for-the-Shifter){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/Data_Quality_Monitoring_for_the_Shifter.txt){.txt}
