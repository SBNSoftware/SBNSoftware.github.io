...
csrf-token: Cc/zcAHumErhETTUhDt9ncHmERwA2nMY0Rfq9jrYljecQIQx+95i+MqvMmYLUcu7JH5DSJ2kBT00qfksf20q4g==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: Checklists - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/Checklists/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=28223&object_type=wiki_page){.wiki_page-28223-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/Checklists/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/Checklists/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/Checklists){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/Checklists/history){.icon
.icon-history}
:::
...
# Checklists[¶](#Checklists){.wiki-anchor}

::: {#section-2 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=2){.icon-only
.icon-edit}
:::

[]{#Start-of-shift-checklist}

## [Start of shift checklist](/redmine/projects/icarus-operations/wiki/Startshift_checklist?parent=Checklists){.wiki-page .new}[¶](#Start-of-shift-checklist){.wiki-anchor}

::: {#section-3 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=3){.icon-only
.icon-edit}
:::

[]{#End-of-shift-checklist}

## [End of shift checklist](/redmine/projects/icarus-operations/wiki/Endshift_checklist?parent=Checklists){.wiki-page .new}[¶](#End-of-shift-checklist){.wiki-anchor}

::: {#section-4 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=4){.icon-only
.icon-edit}
:::

[]{#Cryogenics-checklist}

## [Cryogenics checklist](/redmine/projects/icarus-operations/wiki/Cryogenics_checklist){.wiki-page}[¶](#Cryogenics-checklist){.wiki-anchor}

::: {#section-5 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=5){.icon-only
.icon-edit}
:::

[]{#Cryogenics-checklist-via-EPICS-monitor}

## [Cryogenics checklist via EPICS monitor](/redmine/projects/icarus-operations/wiki/Cryogenics_checklist_via_EPICS){.wiki-page}[¶](#Cryogenics-checklist-via-EPICS-monitor){.wiki-anchor}

This page will discuss the Cryogenics checklist, to be performed every
hour.

::: {#section-6 .contextual .heading-1 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=6){.icon-only
.icon-edit}
:::

[]{#Other-ECL-forms}

# Other ECL forms[¶](#Other-ECL-forms){.wiki-anchor}

::: {#section-7 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=7){.icon-only
.icon-edit}
:::

[]{#Shift-check-in-ECL-form}

## Shift check-in ECL form[¶](#Shift-check-in-ECL-form){.wiki-anchor}

To be filled before the previous shifter leaves.

::: {#section-8 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Checklists/edit?section=8){.icon-only
.icon-edit}
:::

[]{#Shift-check-out-ECL-form}

## Shift check-out ECL form[¶](#Shift-check-out-ECL-form){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/Checklists.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/Checklists.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/Checklists.txt){.txt}
