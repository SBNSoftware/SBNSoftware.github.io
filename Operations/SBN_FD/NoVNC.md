...
csrf-token: RduvWjQTeINpn4XBelMQZEI3vqjqN0nEjAN7n3oSbRzQVNgbziOCMUIhg3P1OaZCp6/s/HdJP+FpvWhFP6fRyQ==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: NoVNC - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/NoVNC/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29568&object_type=wiki_page){.wiki_page-29568-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/NoVNC/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/NoVNC/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/NoVNC){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/NoVNC/history){.icon
.icon-history}
:::
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/NoVNC.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/NoVNC.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/NoVNC.txt){.txt}
