...
csrf-token: OiUL/0tUJjs4+A2T/k/F8phByMMhWJlVYcHmG8dXfjyvqny+sWTciRNGCyFxJXPUfdmal7wm73CEf/XBguLC6Q==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: Troubleshooting Questions - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29603&object_type=wiki_page){.wiki_page-29603-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/history){.icon
.icon-history}
:::
...
# Troubleshooting and Frequently Asked Questions (FAQ)[¶](#Troubleshooting-and-Frequently-Asked-Questions-FAQ){.wiki-anchor}
...
-   [Troubleshooting and Frequently Asked Questions
    (FAQ)](#Troubleshooting-and-Frequently-Asked-Questions-FAQ)
    -   [A PMT (or a few PMTs) are in alarm. Is this a known condition
        or should I contact
        someone?](#A-PMT-or-a-few-PMTs-are-in-alarm-Is-this-a-known-condition-or-should-I-contact-someone)
    -   [Question 2](#Question-2)
    -   [Question 3](#Question-3)

::: {#section-2 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/edit?section=2){.icon-only
.icon-edit}
:::

[]{#A-PMT-or-a-few-PMTs-are-in-alarm-Is-this-a-known-condition-or-should-I-contact-someone}

## A PMT (or a few PMTs) are in alarm. Is this a known condition or should I contact someone?[¶](#A-PMT-or-a-few-PMTs-are-in-alarm-Is-this-a-known-condition-or-should-I-contact-someone){.wiki-anchor}

The list of known PMT conditions are given at [this
Wiki](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off){.wiki-page}.

::: {#section-3 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/edit?section=3){.icon-only
.icon-edit}
:::

[]{#Question-2}

## Question 2[¶](#Question-2){.wiki-anchor}

::: {#section-4 .contextual .heading-2 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions/edit?section=4){.icon-only
.icon-edit}
:::

[]{#Question-3}

## Question 3[¶](#Question-3){.wiki-anchor}
:::
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/Troubleshooting_Questions.txt){.txt}
