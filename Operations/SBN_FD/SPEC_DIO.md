...
csrf-token: BD4k9+3VXL80WXjwqdnjsBd/flVqvYyaKp+z5Qw7f+eRsVO2F+WmDR/nfkIms1WW8ucsAffD+r/PIaA/SY7DMg==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: SPEC DIO - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/SPEC_DIO/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29756&object_type=wiki_page){.wiki_page-29756-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/SPEC_DIO/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/SPEC_DIO/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/SPEC_DIO){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/SPEC_DIO/history){.icon
.icon-history}
:::
...
::: {.wiki .wiki-page}
[]{#SPEC-DIOa-download-the-software-from-sbnd-repository}

# SPEC DIO a) download the software from sbnd repository[¶](#SPEC-DIOa-download-the-software-from-sbnd-repository){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/SPEC_DIO.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/SPEC_DIO.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/SPEC_DIO.txt){.txt}
