...
csrf-token: p6demufwNtQFX7G9MBMO63PPI74Dw4oN2kR7m4n8eskyKCnbHcDMZi7htw+/ebjNlldx6p69/Cg/+mhBzEnGHA==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: PMT On Or Off - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29017&object_type=wiki_page){.wiki_page-29017-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off/history){.icon
.icon-history}
:::

::: {.wiki .wiki-page}
[]{#PMTs-expected-to-be-ONOFF}

# **PMTs expected to be ON/OFF**[¶](#PMTs-expected-to-be-ONOFF){.wiki-anchor}
...
::: {#section-2 .contextual .heading-3 title="Edit this section"}
[Edit this
section](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off/edit?section=2){.icon-only
.icon-edit}
:::

[]{#Last-updated-11-July-2020}

### Last updated 11 July 2020[¶](#Last-updated-11-July-2020){.wiki-anchor}
:::
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/PMT_On_Or_Off.txt){.txt}
