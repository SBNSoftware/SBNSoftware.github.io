...
csrf-token: omKePFCAOwZ4L6PdA60lKnbdPgLYAbZtsMXqu8B9fdM37el9qrDBtFORpW+Mx5MMk0VsVkV/wEhVe/lhhcjBBg==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: SPEC Cards - ICARUS operations - Fermilab Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/SPEC_Cards/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=29755&object_type=wiki_page){.wiki_page-29755-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/SPEC_Cards/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/SPEC_Cards/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/SPEC_Cards){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/SPEC_Cards/history){.icon
.icon-history}
:::
...
# SPEC Cards[¶](#SPEC-Cards){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/SPEC_Cards.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/SPEC_Cards.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/SPEC_Cards.txt){.txt}
