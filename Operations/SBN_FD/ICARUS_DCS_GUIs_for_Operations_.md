...
csrf-token: HiWGOjd6oL2MMQJKhZqUvytaFUrDAi6pfGkg7NjeIcCLqvF7zUpaD6ePBPgK8CKZzsJHHl58WIyZ1zM2nWudFQ==
description: Redmine
keywords: issue,bug,tracker
lang: en
title: ICARUS DCS GUIs for Operations - ICARUS operations - Fermilab
  Redmine
...
.icon-add}
[Edit](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/edit){.icon
.icon-edit}
[Watch](/redmine/watchers/watch?object_id=28357&object_type=wiki_page){.wiki_page-28357-watcher
.icon .icon-fav-off}
[Lock](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/protect?protected=1){.icon
.icon-lock}
[Rename](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/rename){.icon
.icon-move}
[Delete](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_){.icon
.icon-del}
[History](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/history){.icon
.icon-history}
:::
...
# ICARUS DCS GUIs for Operations[¶](#ICARUS-DCS-GUIs-for-Operations){.wiki-anchor}

These instructions start on 09-October-2020.

-   **Table of contents**
-   [ICARUS DCS GUIs for Operations](#ICARUS-DCS-GUIs-for-Operations)
    -   [Start the CSS GUI for PMT](#Start-the-CSS-GUI-for-PMT)
    -   [Start the CSS GUI for Cathode
        HV](#Start-the-CSS-GUI-for-Cathode-HV)
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/edit?section=2){.icon-only
.icon-edit}
:::

[]{#Start-the-CSS-GUI-for-PMT}

## Start the CSS GUI for PMT[¶](#Start-the-CSS-GUI-for-PMT){.wiki-anchor}
...
[Edit this
section](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_/edit?section=3){.icon-only
.icon-edit}
:::

[]{#Start-the-CSS-GUI-for-Cathode-HV}

## Start the CSS GUI for Cathode HV[¶](#Start-the-CSS-GUI-for-Cathode-HV){.wiki-anchor}
...
Also available in:
[PDF](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_.pdf){.pdf}
[HTML](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_.html){.html}
[TXT](/redmine/projects/icarus-operations/wiki/ICARUS_DCS_GUIs_for_Operations_.txt){.txt}
