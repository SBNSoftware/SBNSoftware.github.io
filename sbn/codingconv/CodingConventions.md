...
**[F]** The use of `const_cast` and `reinterpret_cast` is **forbidden** except when interfacing with broken library code, in which case a large and thorough comment is required.
